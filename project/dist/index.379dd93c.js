...
const API = new _fetchWrapperJsDefault.default("https://firestore.googleapis.com/v1/projects/jsdemo-3f387/databases/(default)/documents/YOURNAMESPACEHERE");
const appData = new _appDataJsDefault.default();
const list = document.querySelector("#food-list");
const form = document.querySelector("#create-form");
const name1 = document.querySelector("#create-name");
const carbs1 = document.querySelector("#create-carbs");
const protein1 = document.querySelector("#create-protein");
const fat1 = document.querySelector("#create-fat");
const displayEntry = (name, carbs, protein, fat)=>{
    ...
    list.insertAdjacentHTML("beforeend", `<li class="card">
        <div>
          <h3 class="name">${_helpersJs.capitalize(name)}</h3>
          <div class="calories">${_helpersJs.calculateCalories(carbs, protein, fat)} calories</div>
          <ul class="macros">
...
form.addEventListener("submit", (event)=>{
    ...
    API.post("/", {
        fields: {
            name: {
                stringValue: name1.value
            },
            carbs: {
                integerValue: carbs1.value
            },
            protein: {
                integerValue: protein1.value
            },
            fat: {
                integerValue: fat1.value
            }
        }
    }).then((data)=>{
        console.log(data);
        ...
        displayEntry(name1.value, carbs1.value, protein1.value, fat1.value);
        render();
        name1.value = "";
        carbs1.value = "";
        protein1.value = "";
...
const renderChart = ()=>{
    ...
    chartInstance = new _autoDefault.default(context, {
        type: "bar",
        data: {
            labels: [
                "Carbs",
...
},{"./fetch-wrapper.js":"kOP72","./helpers.js":"cc0zK","snackbar":"9g8mm","./app-data.js":"d1ppy","snackbar/dist/snackbar.min.css":"atyfN","chart.js/auto":"j1lNe","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"kOP72":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
class FetchWrapper {
    ...
    put(endpoint1, body) {
        return this._send("put", endpoint1, body);
    }
    post(endpoint2, body1) {
        return this._send("post", endpoint2, body1);
    }
    patch(endpoint3, body2) {
        return this._send("patch", endpoint3, body2);
    }
    delete(endpoint4, body3) {
        return this._send("delete", endpoint4, body3);
    }
    _send(method, endpoint5, body4) {
        return fetch(this.baseURL + endpoint5, {
            method,
            headers: {
...
},{}],"cc0zK":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "capitalize", ()=>capitalize
);
parcelHelpers.export(exports, "calculateCalories", ()=>calculateCalories
);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"9g8mm":[function(require,module,exports) {
'use strict';
var _snackbar = require('./snackbar');
...
},{"./snackbar":"lKKi4"}],"lKKi4":[function(require,module,exports) {
'use strict';
...
exports.default = Snackbar1;

},{}],"d1ppy":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class AppData {
    constructor(){
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"atyfN":[function() {},{}],"j1lNe":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}]},["lBB98","hD4hw"], "hD4hw", "parcelRequireaec4")
